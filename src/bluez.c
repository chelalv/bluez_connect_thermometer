 ...
 *          InterfacesRemoved
 * - 功能包括：
 *   1. bluez_list_controllers_devices 列出现有的controllers以及devices
 *   2. 调用扫描函数
 *   3. 订阅InterfacesAdded信号，来得知是否扫描到特定设备，服务和特征值是否扫描到了
 *
 */
